define(["@grafana/data","react","@emotion/css","@grafana/ui","@grafana/runtime"],(e,t,a,n,r)=>(()=>{"use strict";var o={89(e){e.exports=a},388(e){e.exports=n},531(e){e.exports=r},781(t){t.exports=e},959(e){e.exports=t}},l={};function s(e){var t=l[e];if(void 0!==t)return t.exports;var a=l[e]={exports:{}};return o[e](a,a.exports,s),a.exports}s.n=e=>{var t=e&&e.__esModule?()=>e.default:()=>e;return s.d(t,{a:t}),t},s.d=(e,t)=>{for(var a in t)s.o(t,a)&&!s.o(e,a)&&Object.defineProperty(e,a,{enumerable:!0,get:t[a]})},s.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),s.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var c={};s.r(c),s.d(c,{plugin:()=>z});var i=s(781),d=s(959),u=s.n(d),p=s(89),m=s(388),f=s(531);const g="_fm-",h="_fa-",v={include:{single:"=",multi:"IN"},exclude:{single:"!=",multi:"NOT IN"}};function y(){const e=new URLSearchParams(window.location.search),t={};return e.forEach((e,a)=>{if(a.startsWith(g)){const n=a.slice(4);t[n]||(t[n]={name:n,mode:"include",active:!0}),t[n].mode="exclude"===e?"exclude":"include"}else if(a.startsWith(h)){const n=a.slice(4);t[n]||(t[n]={name:n,mode:"include",active:!0}),t[n].active="false"!==e}}),t}function b(e){const t={};Object.values(e).forEach(e=>{const a=`${g}${e.name}`,n=`${h}${e.name}`;"include"!==e.mode?t[a]=e.mode:t[a]=null,e.active?t[n]=null:t[n]="false"}),f.locationService.partial(t,!0)}const x=e=>({menu:p.css`
  ...
  `,compactLabel:p.css`
    font-size: ${e.typography.bodySmall.fontSize};
  `}),E=({variable:e,filterState:t,currentValues:a,showLabel:n,compact:r,onModeChange:o,onActiveChange:l,isAdHoc:s=!1})=>{const c=(0,m.useStyles2)(w),[i,f]=(0,d.useState)(!1),g=(0,d.useCallback)(()=>{f(e=>!e)},[]),h=(0,d.useCallback)(()=>{f(!1)},[]),v=e.label||e.name,y=a.length>0,b=r?2:3,x=a.slice(0,b),E=a.length-b,k=(0,p.cx)(c.container,r&&c.compact,!t.active&&c.containerInactive,t.active&&"exclude"===t.mode&&c.containerExclude),S=(0,p.cx)(c.valueTag,"exclude"===t.mode&&t.active&&c.valueTagExclude,!t.active&&c.valueTagInactive);return u().createElement(m.Tooltip,{content:s?`Ad hoc filter · ${t.active?"Active":"Inactive"} · Click to configure`:`${"include"===t.mode?"Including":"Excluding"} · ${t.active?"Active":"Inactive"} · Click to configure`,placement:"top"},u().createElement("div",{className:k,onClick:g,role:"button",tabIndex:0,onKeyDown:e=>"Enter"===e.key&&g()},!s&&u().createElement("span",{className:(0,p.cx)(c.modeIndicator,"include"===t.mode?c.modeInclude:c.modeExclude)},"include"===t.mode?"=":"≠"),n&&u().createElement(u().Fragment,null,u().createElement("span",{className:(0,p.cx)(c.label,r&&c.compactLabel,!t.active&&c.labelInactive)},v),u().createElement("span",{className:c.separator},":")),u().createElement("div",{className:c.valuesWrapper},y?u().createElement(u().Fragment,null,x.map((e,t)=>u().createElement("span",{key:t,className:S},e)),E>0&&u().createElement("span",{className:c.moreValues},"+",E," more")):u().createElement("span",{className:c.noValues},"No selection")),u().createElement("span",{className:(0,p.cx)(c.statusDot,!t.active&&c.statusDotInactive)}),u().createElement(m.Icon,{name:"angle-down",className:(0,p.cx)(c.menuIcon,i&&c.menuIconOpen)}),i&&u().createElement($,{filterState:t,onModeChange:o,onActiveChange:l,onClose:h,isAdHoc:s})))};function k(e){return null==e?"NULL":e.replace(/'/g,"''")}function S(e,t,a){if(!a.active)return"";const n=function(e){if(!e)return[];let t=[];if(Array.isArray(e))e.forEach(e=>{if(e&&"string"==typeof e)if(e.includes(",")){const a=e.split(",").map(e=>e.trim()).filter(Boolean);t.push(...a)}else"$__all"!==e&&"All"!==e&&""!==e&&"None"!==e&&t.push(e.trim())});else if("string"==typeof e){if("$__all"===e||"All"===e||""===e)return[];t=e.includes(",")?e.split(",").map(e=>e.trim()).filter(e=>e&&"$__all"!==e&&"All"!==e&&"None"!==e):[e.trim()]}return[...new Set(t)].filter(e=>e&&"$__all"!==e&&"All"!==e&&"None"!==e)}(t);if(0===n.length)return"";const r=v[a.mode];if(1===n.length){const t=k(n[0]);return`AND ${e} ${r.single} '${t}'`}const o=n.map(e=>`'${k(e)}'`).join(", ");return`AND ${e} ${r.multi} (${o})`}function N(e,t){if(!t.active)return"";let a="";if(Array.isArray(e)){if(e.length>1)return"";1===e.length&&(a=e[0].trim())}else if("string"==typeof e){if(e.includes(","))return"";a=e.trim()}return a&&"$__all"!==a&&"All"!==a&&""!==a?"include"===t.mode?`AND (${a})`:`AND NOT (${a})`:""}function A(e){return e&&0!==e.length?e.map(e=>function(e){const t={"=":"=","!=":"!=","<":"<",">":">","<=":"<=",">=":">=","=~":"LIKE","!~":"NOT LIKE"}[a=e.operator]||a;var a;const n=k(e.value);return`AND ${e.key} ${t} '${n}'`}(e)).join("\n  "):""}const L=e=>({container:p.css`
    display: flex;
  ...
  `,compact:p.css`
    padding: ${e.spacing(.5)};
    gap: ${e.spacing(.5)};
  `});function F(e){return e?Array.isArray(e)?e.filter(e=>e&&"$__all"!==e&&"All"!==e&&"None"!==e).map(e=>String(e).trim()).filter(Boolean):"string"==typeof e?"$__all"===e||"All"===e||""===e||"None"===e?[]:e.includes(",")?e.split(",").map(e=>e.trim()).filter(e=>e&&"$__all"!==e&&"All"!==e&&"None"!==e):[e.trim()]:[]:[]}function C(e){const t={},a=(0,f.getTemplateSrv)();return(new Date).toISOString().split("T")[1].slice(0,12),e.forEach(e=>{const n=e;let r=[],o="";const l=a.replace(`$${e.name}`);if(l&&l!==`$${e.name}`)if("$__all"===l||"All"===l||""===l||"None"===l){const t=new URLSearchParams(window.location.search).get(`var-${e.name}`);""===t||"$__all"===t||"All"===t||"None"===t||null===t?(r=[],o="template-cleared"):(r=F(t),o="URL-override")}else{const e=function(e){if(!e)return[];const t=e.trim();return t.startsWith("{")&&t.endsWith("}")?t.slice(1,-1).split(",").map(e=>e.trim()).filter(Boolean):[]}(l);e.length>0?(r=e,o="template-clickhouse"):(r=F(l),o="template")}if(0===r.length&&""===o){const t=new URLSearchParams(window.location.search).get(`var-${e.name}`);null!==t&&(""===t||"$__all"===t||"All"===t||"None"===t?(r=[],o="URL-cleared"):(r=F(t),o="URL"))}if(0===r.length&&""===o&&void 0!==n.current?.value){const e=n.current.value;"$__all"===e||"All"===e||""===e||"None"===e?(r=[],o="current-cleared"):(r=F(e),o="current")}if(0===r.length&&""===o&&n.options){const e=n.options.filter(e=>e.selected&&"$__all"!==e.value&&"All"!==e.value&&"None"!==e.value).map(e=>e.value);e.length>0&&(r=F(e),o="options")}t[e.name]=r}),t}const z=new i.PanelPlugin(({options:e,width:t,height:a,data:n,timeRange:r,eventBus:o})=>{const l=(0,m.useStyles2)(L),{getFilterState:s,setMode:c,setActive:i}=function(){const[e,t]=(0,d.useState)(()=>y());(0,d.useEffect)(()=>{const e=()=>{t(y())};return window.addEventListener("popstate",e),()=>window.removeEventListener("popstate",e)},[]);const a=(0,d.useCallback)(t=>e[t]||{name:t,mode:"include",active:!0},[e]),n=(0,d.useCallback)(e=>{t(t=>{const a=t[e]||{name:e,mode:"include",active:!0},n={...t,[e]:{...a,mode:"include"===a.mode?"exclude":"include"}};return b(n),n})},[]),r=(0,d.useCallback)(e=>{t(t=>{const a=t[e]||{name:e,mode:"include",active:!0},n={...t,[e]:{...a,active:!a.active}};return b(n),n})},[]),o=(0,d.useCallback)((e,a)=>{t(t=>{const n=t[e]||{name:e,mode:"include",active:!0},r={...t,[e]:{...n,mode:a}};return b(r),r})},[]),l=(0,d.useCallback)((e,a)=>{t(t=>{const n=t[e]||{name:e,mode:"include",active:!0},r={...t,[e]:{...n,active:a}};return b(r),r})},[]),s=(0,d.useCallback)(()=>{t({}),b({})},[]);return{filterState:e,getFilterState:a,toggleMode:n,toggleActive:r,setMode:o,setActive:l,resetAll:s}}(),g=(0,f.getTemplateSrv)(),[h,v]=(0,d.useState)(!1),[x,$]=(0,d.useState)(new Set),w=(0,d.useMemo)(()=>g.getVariables(),[g]),k=(0,d.useMemo)(()=>w.filter(e=>{const t=e;return"adhoc"===t.type||"ad-hoc"===t.type||"adHoc"===t.type||"datasource"===t.type}),[w]),F=(0,d.useMemo)(()=>{if(e.variableNames&&e.variableNames.length>0){const t="string"==typeof e.variableNames?e.variableNames.split(",").map(e=>e.trim()).filter(Boolean):e.variableNames;return w.filter(e=>t.includes(e.name))}return w.filter(e=>{const t=e;return"query"===t.type||"textbox"===t.type&&"FreeFilter"===e.name})},[w,e.variableNames]),[z,I]=(0,d.useState)({}),[_,T]=(0,d.useState)({}),M=(0,d.useRef)(()=>{const e=C(F);I({...e})}),R=(0,d.useRef)(()=>{const e={};g.getVariables().filter(e=>"adhoc"===e.type).forEach(t=>{const a=t,n=a.filters||[],r=a.current?.filters||[],o=a.state?.filters||[];a.options,a.query;const l=n.length>0?n:r.length>0?r:o.length>0?o:[];e[t.name]=l.map(e=>({key:e.key,operator:e.operator,value:e.value}))}),T({...e})});(0,d.useEffect)(()=>{M.current=()=>{const e=C(F);I({...e})}},[F]),(0,d.useEffect)(()=>{R.current=()=>{const e={};g.getVariables().filter(e=>"adhoc"===e.type).forEach(t=>{const a=t,n=a.filters||[],r=a.current?.filters||[],o=a.state?.filters||[],l=n.length>0?n:r.length>0?r:o.length>0?o:[];e[t.name]=l.map(e=>({key:e.key,operator:e.operator,value:e.value}))}),T({...e})}},[g]),(0,d.useEffect)(()=>{M.current(),R.current();const e=setInterval(()=>{M.current(),R.current()},50);return()=>clearInterval(e)},[]),(0,d.useEffect)(()=>f.locationService.getHistory().listen(()=>{setTimeout(()=>{M.current(),R.current()},10)}),[]),(0,d.useEffect)(()=>{M.current(),R.current()},[n.series.length,r]);const V=(0,d.useMemo)(()=>{const e=F.filter(e=>"FreeFilter"!==e.name).map(e=>{const t=s(e.name),a=z[e.name]||[];return S(e.name,a,t)}).filter(e=>""!==e),t=(F.find(e=>"FreeFilter"===e.name)?[N(z.FreeFilter,s("FreeFilter"))]:[]).filter(e=>""!==e),a=[];k.forEach(e=>{if(s(e.name).active){const t=_[e.name]||[];a.push(...t)}});const n=A(a),r=[...e,...t,...n?n.split("\n  ").filter(Boolean):[]];return 0===F.length&&0===k.length?"-- No variables configured":0===r.length?"-- No active filters":`-- Generated WHERE clauses:\n${r.join("\n")}`},[F,k,s,z,_]);(0,d.useMemo)(()=>{const e=F.filter(e=>"FreeFilter"!==e.name).map(e=>{const t=s(e.name),a=z[e.name]||[];return S(e.name,a,t)}).filter(e=>""!==e),t=(F.find(e=>"FreeFilter"===e.name)?[N(z.FreeFilter,s("FreeFilter"))]:[]).filter(e=>""!==e),a=[];k.forEach(e=>{if(s(e.name).active){const t=_[e.name]||[];a.push(...t)}});const n=A(a);return[...e,...t,...n?n.split("\n  ").filter(Boolean):[]].join("\n")},[F,k,s,z,_]),(0,d.useMemo)(()=>g.getVariables().filter(e=>"adhoc"===e.type).map(e=>{const t=e,a=_[e.name]||[],n=Object.keys(t),r=t.filters||[],o=t.current?.filters||[],l=t.state?.filters||[],s=t.current?.value,c=t.current?.text,i=r.length,d=o.length,u=l.length;return{name:e.name,type:"adhoc",filterCount:a.length,filters:a,debugInfo:{allKeys:n.join(", "),hasFilters:i,hasCurrentFilters:d,hasStateFilters:u,currentValue:JSON.stringify(s),currentText:JSON.stringify(c),filtersLocation:i>0?"filters":d>0?"current.filters":u>0?"state.filters":"NONE"}}}),[_,g]),(0,d.useMemo)(()=>F.map(e=>{const t=e,a=new URLSearchParams(window.location.search).get(`var-${e.name}`),n=g.replace(`$${e.name}`),r=t.current?.value,o=z[e.name];return{name:e.name,type:t.type||"unknown",url:a,template:n!==`$${e.name}`?n:"N/A",current:JSON.stringify(r),panel:JSON.stringify(o)}}),[F,z,g]),(0,d.useEffect)(()=>{const e=F.filter(e=>"FreeFilter"!==e.name).map(e=>{const t=s(e.name),a=z[e.name]||[];return S(e.name,a,t)}).filter(e=>""!==e),t=(F.find(e=>"FreeFilter"===e.name)?[N(z.FreeFilter,s("FreeFilter"))]:[]).filter(e=>""!==e),a=[];k.forEach(e=>{if(s(e.name).active){const t=_[e.name]||[];a.push(...t)}});const n=A(a),r=[...e,...t,...n?n.split("\n  ").filter(Boolean):[]].join("\n");if(new URLSearchParams(window.location.search).get("var-alaela_sql")!==r){const e=r||"-- No active filters";f.locationService.partial({"var-alaela_sql":e},!0)}},[F,k,s,z,_]);const O=(0,d.useCallback)(()=>{if(h)x.forEach(e=>{i(e,!0)}),v(!1);else{const e=new Set;F.forEach(t=>{s(t.name).active&&(e.add(t.name),i(t.name,!1))}),k.forEach(t=>{s(t.name).active&&(e.add(t.name),i(t.name,!1))}),$(e),v(!0)}},[h,x,F,k,s,i]);return 0===F.length?u().createElement("div",{className:(0,p.cx)(l.container,e.compact&&l.compact)},u().createElement(m.Alert,{title:"No variables found",severity:"info"},"Add Query-type variables to your dashboard, or specify variable names in the panel options.")):u().createElement("div",{className:(0,p.cx)(l.container,e.compact&&l.compact),style:{position:"relative"}},V&&u().createElement(m.Tooltip,{content:u().createElement("pre",{style:{margin:0,whiteSpace:"pre-wrap",maxWidth:"600px"}},V),placement:"bottom-end"},u().createElement("div",{style:{position:"absolute",top:"8px",right:"8px",padding:"4px 10px",background:"#1f1f1f",border:"1px solid #444",borderRadius:"4px",cursor:"help",fontSize:"11px",fontWeight:"bold",color:"#aaa",zIndex:1e3,transition:"all 0.2s ease"},onMouseEnter:e=>{e.currentTarget.style.background="#2a2a2a",e.currentTarget.style.color="#fff",e.currentTarget.style.borderColor="#666"},onMouseLeave:e=>{e.currentTarget.style.background="#1f1f1f",e.currentTarget.style.color="#aaa",e.currentTarget.style.borderColor="#444"}},"SQL")),!1,u().createElement("div",{className:(0,p.cx)(l.filtersWrapper,"horizontal"===e.layout?l.filtersHorizontal:l.filtersVertical)},u().createElement("div",{style:{position:"relative",display:"flex",alignItems:"center",gap:"8px",padding:e.compact?"4px 12px":"8px 16px",background:h?"#ff4444":"#2a2a2a",border:"1px solid "+(h?"#ff6666":"#444"),borderRadius:"4px",cursor:"pointer",transition:"all 0.15s ease",userSelect:"none"},onClick:O,onMouseEnter:e=>{e.currentTarget.style.background=h?"#ff5555":"#333",e.currentTarget.style.borderColor=h?"#ff7777":"#555"},onMouseLeave:e=>{e.currentTarget.style.background=h?"#ff4444":"#2a2a2a",e.currentTarget.style.borderColor=h?"#ff6666":"#444"}},u().createElement("span",{style:{fontSize:e.compact?"16px":"18px"}},h?"🚫":"⚡"),e.showLabels&&u().createElement("span",{style:{fontSize:e.compact?"12px":"14px",fontWeight:500,color:h?"#fff":"#aaa"}},"BlockAll"),u().createElement("div",{style:{width:e.compact?"32px":"40px",height:e.compact?"16px":"20px",background:h?"#ff6666":"#555",borderRadius:"10px",position:"relative",transition:"background 0.2s ease",marginLeft:"auto"}},u().createElement("div",{style:{position:"absolute",top:"2px",left:h?e.compact?"16px":"22px":"2px",width:e.compact?"12px":"16px",height:e.compact?"12px":"16px",background:"white",borderRadius:"50%",transition:"left 0.2s ease"}})),h&&x.size>0&&u().createElement("span",{style:{background:"#fff",color:"#ff4444",fontSize:e.compact?"10px":"11px",fontWeight:"bold",padding:"2px 6px",borderRadius:"10px",minWidth:e.compact?"16px":"20px",textAlign:"center"}},x.size)),F.map(t=>{const a=s(t.name),n=z[t.name]||[];return u().createElement(E,{key:t.name,variable:t,filterState:a,currentValues:n,showLabel:e.showLabels,compact:e.compact,onModeChange:e=>c(t.name,e),onActiveChange:e=>i(t.name,e),isAdHoc:!1})}),k.map(t=>{const a=s(t.name),n=(_[t.name]||[]).map(e=>`${e.key} ${e.operator} ${e.value}`);return u().createElement(E,{key:t.name,variable:t,filterState:a,currentValues:n,showLabel:e.showLabels,compact:e.compact,onModeChange:e=>c(t.name,e),onActiveChange:e=>i(t.name,e),isAdHoc:!0})})),!1)}).setPanelOptions(e=>{e.addTextInput({path:"variableNames",name:"Variable Names",description:"Comma-separated list of variable names to display. Leave empty to show all Query variables.",defaultValue:"",settings:{placeholder:"server, region, status"}}).addRadio({path:"layout",name:"Layout",description:"How to arrange the variable filters",defaultValue:"horizontal",settings:{options:[{value:"horizontal",label:"Horizontal"},{value:"vertical",label:"Vertical"}]}}).addBooleanSwitch({path:"showLabels",name:"Show Labels",description:"Display variable labels/names",defaultValue:true}).addBooleanSwitch({path:"compact",name:"Compact Mode",description:"Reduce padding and spacing",defaultValue:false})}).setNoPadding();return c})());
